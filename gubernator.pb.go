...
// PeerHealthResp describes a single peer as seen by the health check.
type PeerHealthResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The gRPC address of the peer.
	GrpcAddress string `protobuf:"bytes,1,opt,name=grpc_address,json=grpcAddress,proto3" json:"grpc_address,omitempty"`
	// The datacenter this peer belongs to. Empty when not using multi-datacenter
	// peer discovery.
	DataCenter string `protobuf:"bytes,2,opt,name=data_center,json=dataCenter,proto3" json:"data_center,omitempty"`
}

func (x *PeerHealthResp) Reset() {
	*x = PeerHealthResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *PeerHealthResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerHealthResp) ProtoMessage() {}

func (x *PeerHealthResp) ProtoReflect() protoreflect.Message {
	mi := &file_gubernator_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerHealthResp.ProtoReflect.Descriptor instead.
func (*PeerHealthResp) Descriptor() ([]byte, []int) {
	return file_gubernator_proto_rawDescGZIP(), []int{5}
}

func (x *PeerHealthResp) GetGrpcAddress() string {
	if x != nil {
...
func (x *PeerHealthResp) GetDataCenter() string {
	if x != nil {
		return x.DataCenter
	}
	return ""
...
type HealthCheckResp struct {
	...
	// local_peers lists all peers in the local datacenter (LocalPicker).
	// These are the peers this instance directly coordinates rate limits with.
	LocalPeers []*PeerHealthResp `protobuf:"bytes,5,rep,name=local_peers,json=localPeers,proto3" json:"local_peers,omitempty"`
	// region_peers lists all peers in remote datacenters (RegionPicker).
	// These peers receive forwarded rate limit requests for GLOBAL behavior.
	// Empty when not using multi-datacenter peer discovery.
	RegionPeers []*PeerHealthResp `protobuf:"bytes,6,rep,name=region_peers,json=regionPeers,proto3" json:"region_peers,omitempty"`
}
...
func (x *HealthCheckResp) GetAdvertiseAddress() string {
	if x != nil {
...
func (x *HealthCheckResp) GetLocalPeers() []*PeerHealthResp {
	if x != nil {
		return x.LocalPeers
	}
	return nil
...
func (x *HealthCheckResp) GetRegionPeers() []*PeerHealthResp {
	if x != nil {
		return x.RegionPeers
	}
	return nil
}
...
func (x *LiveCheckReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LiveCheckReq) ProtoMessage() {}

func (x *LiveCheckReq) ProtoReflect() protoreflect.Message {
	mi := &file_gubernator_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LiveCheckReq.ProtoReflect.Descriptor instead.
...
func (x *LiveCheckResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LiveCheckResp) ProtoMessage() {}

func (x *LiveCheckResp) ProtoReflect() protoreflect.Message {
	mi := &file_gubernator_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LiveCheckResp.ProtoReflect.Descriptor instead.
...
var file_gubernator_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x22, 0x54, 0x0a, 0x0e, 0x50, 0x65, 0x65, 0x72, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	0x52, 0x65, 0x73, 0x70, 0x12, 0x21, 0x0a, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x67, 0x72, 0x70, 0x63,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x5f,
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x61,
	0x74, 0x61, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x22, 0x91, 0x02, 0x0a, 0x0f, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06,
	...
	,
	...
	,
...
var file_gubernator_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_gubernator_proto_goTypes = []interface{}{
	...
	(*PeerHealthResp)(nil),    // 8: pb.gubernator.PeerHealthResp
	(*HealthCheckResp)(nil),   // 9: pb.gubernator.HealthCheckResp
	(*LiveCheckReq)(nil),      // 10: pb.gubernator.LiveCheckReq
	(*LiveCheckResp)(nil),     // 11: pb.gubernator.LiveCheckResp
	nil,                       // 12: pb.gubernator.RateLimitReq.MetadataEntry
	nil,                       // 13: pb.gubernator.RateLimitResp.MetadataEntry
}
var file_gubernator_proto_depIdxs = []int32{
	...
	12, // 4: pb.gubernator.RateLimitReq.metadata:type_name -> pb.gubernator.RateLimitReq.MetadataEntry
	2,  // 5: pb.gubernator.RateLimitResp.status:type_name -> pb.gubernator.Status
	13, // 6: pb.gubernator.RateLimitResp.metadata:type_name -> pb.gubernator.RateLimitResp.MetadataEntry
	8,  // 7: pb.gubernator.HealthCheckResp.local_peers:type_name -> pb.gubernator.PeerHealthResp
	8,  // 8: pb.gubernator.HealthCheckResp.region_peers:type_name -> pb.gubernator.PeerHealthResp
	3,  // 9: pb.gubernator.V1.GetRateLimits:input_type -> pb.gubernator.GetRateLimitsReq
	7,  // 10: pb.gubernator.V1.HealthCheck:input_type -> pb.gubernator.HealthCheckReq
	10, // 11: pb.gubernator.V1.LiveCheck:input_type -> pb.gubernator.LiveCheckReq
	4,  // 12: pb.gubernator.V1.GetRateLimits:output_type -> pb.gubernator.GetRateLimitsResp
	9,  // 13: pb.gubernator.V1.HealthCheck:output_type -> pb.gubernator.HealthCheckResp
	11, // 14: pb.gubernator.V1.LiveCheck:output_type -> pb.gubernator.LiveCheckResp
